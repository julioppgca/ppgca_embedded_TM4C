...
linker.cmd: package/cfg/RTOS_config_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/RTOS_config_pem4fcfg.cmd\)\"$""\"/Users/juliosantos/Embedded2_ppgca/TM4C_RTOS_Template/.config/xconfig_RTOS_config/\1\""' package/cfg/RTOS_config_pem4f.xdl > $@
