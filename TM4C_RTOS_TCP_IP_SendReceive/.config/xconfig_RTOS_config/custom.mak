...
linker.cmd: package/cfg/RTOS_config_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/RTOS_config_pem4fcfg.cmd\)\"$""\"C:/Users/skelter_win/embedded2/ppgca_embedded_TM4C/TM4C_RTOS_TCP_IP_SendReceive/.config/xconfig_RTOS_config/\1\""' package/cfg/RTOS_config_pem4f.xdl > $@
